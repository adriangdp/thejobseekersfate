...
{#if isCardDisplay}
    <div class="relative w-full aspect-2/3 bg-accent-inner p-3 border-accent-outer border-1 bg-radial from-white/0 to-white/0 overflow-hidden">        
        <div class="relative mx-auto z-20 h-1/2 flex flex-col justify-end">
        ...
        <div class={`w-full h-full absolute top-0 left-0 ${status.styles.background}`}>
            <div class="w-full h-full bg-radial from-black/0 from-55% to-black/55"></div>
        </div>       
    </div>
{:else}
    <tr>
